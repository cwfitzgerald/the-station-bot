...
object Main {
	def main(args: Array[String]): Unit = {
		...
		client ! Client.AddCommand("addcars", commands.registry.cars)
		client ! Client.AddCommand("remcars", commands.registry.cars)
		client ! Client.AddCommand("addtype", commands.registry.types)
		client ! Client.AddCommand("remtype", commands.registry.types)
