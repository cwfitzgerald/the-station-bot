...
object Main {
	def main(args: Array[String]): Unit = {
		...
		client ! Client.AddAdminCommand("addcars", commands.registry.cars)
		client ! Client.AddAdminCommand("remcars", commands.registry.cars)
		client ! Client.AddAdminCommand("addtype", commands.registry.types)
		client ! Client.AddAdminCommand("remtype", commands.registry.types)
